...
<html lang="pt-PT" xml:lang="pt-PT">
    <head>
        ...
        <title>CartBar - Pastelaria</title>
    ...
    <body>
        ...
        <div id="main">
            ...
            <div class="content">
                <div class="pure-g">
                    <div class="pure-menu pure-menu-open pure-menu-horizontal pure-u-1-4">
                        <ul>
                            <li id="menu-1"><a href="menuEmenta.php">Aperitivos</a></li>
                            <li id="menu-2"><a href="menuPromocoes.php">Cafetaria</a></li>
                            <li id="menu-3" class="pure-menu-selected"><a href="#">Pastelaria</a></li>
                            <li id="menu-4"><a href="menuTop.php">Restauracao</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="pure-g-r">
                    ...
                    <div id="indexacao" class="pure-u-1" style="margin: 0.5cm;">
                        ...
                        echo $echoElems;
                        ?>
                        var div = "<table id=\"produtos-table\" class=\"pure-table\"><thead><tr><th></th><th scope=\"col\">Nome</th><th scope=\"col\">Pre&ccedil;o</th></tr></thead><tbody id=\"produtos-tbody\">";
                        var i = 2 >= categorias.length ? categorias.length-1 : 2;
