        ...
        <div id="main">
            ...
            <div class="content">
                <div class="pure-g">
                    <div class="pure-menu pure-menu-open pure-menu-horizontal pure-u-1">
                        <ul>
                            ...
                            <li id="menu-2" class="pure-menu-selected"><a href="#">Cafetaria</a></li>
                ...
                <div id="indexacao" class="pure-u-1" style="margin: 0.5cm;">
                    ...
                    echo $echoElems;
                    ?>
                    var div = "<div><table id=\"produtos-table\" class=\"pure-table\"><thead><tr><th scope=\"col\"></th><th>Nome</th><th scope=\"col\">Pre&ccedil;o</th></tr></thead><tbody id=\"produtos-tbody\">";
                    var i = 1 >= categorias.length ? categorias.length-1 : 1;
