...
<html lang="pt-PT" xml:lang="pt-PT">
    <head>
        ...
        <title>CartBar - Aperitivos</title>
        ...
        <div id="main">
            ...
            <div class="content">
                <div class="pure-menu pure-menu-open pure-menu-horizontal">
                    <ul>
                        <li id="menu-1" class="pure-menu-selected"><a href="#">Aperitivos</a></li>
                        <li id="menu-2"><a href=<?php echo '"menuPromocoes.php?mesa='.$_GET["mesa"].'"';?>>Cafetaria</a></li>
                        <li id="menu-3"><a href=<?php echo '"menuNovidades.php?mesa='.$_GET["mesa"].'"';?>>Pastelaria</a></li>
                        <li id="menu-4"><a href=<?php echo '"menuTop.php?mesa='.$_GET["mesa"].'"';?>>Restauracao</a></li>
                    </ul>
                </div>
            ...
            <div class="pure-g-r">
                ...
                <div id="indexacao" class="pure-u-1" style="margin: 0.5cm;">
                    ...
                    echo $echoElems;
                    ?>
                    var div = "<div><table id=\"produtos-table\" class=\"pure-table\"><thead><tr><th></th><th scope=\"col\">Nome</th><th scope=\"col\">Pre&ccedil;o</th></tr></thead><tbody id=\"produtos-tbody\">";
                    var i = 0 >= categorias.length ? categorias.length-1 : 0;
