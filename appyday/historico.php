                ...
                <ul>
                    <?php 
                        ...
                        if($_REQUEST["pagar"] == 1) {
                            ...
                            $pedidos = $connection->prepare($connection, "UPDATE Carrinho SET status = 'pago' WHERE email = ?;");
        ...
        <div id="main">
            ...
            <div class="content">
                ...
                <?php
                    ...
                    $pedidos = mysqli_query($connection, "SELECT DISTINCT nome, produtosQTD, preco FROM Carrinho NATURAL JOIN Produtos WHERE status = 'pago' ORDER BY nome;");
